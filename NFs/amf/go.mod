...
require (
	...
	// github.com/enable-intelligent-containerized-5g/nas v1.1.1
...
require (
	github.com/enable-intelligent-containerized-5g/nas v1.0.71
	github.com/enable-intelligent-containerized-5g/ngap v1.0.61
