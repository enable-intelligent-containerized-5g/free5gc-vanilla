...
// 	locationHeader := fmt.Sprintf("%s/policy-data/subs-to-notify/%s", nwdafSelf.GetIPv4GroupUri(udr_context.NUDR_DR),
// 		newSubscriptionID)
...
// 	value, ok := nwdafSelf.UEGroupCollection.Load(ueGroupId)
// 	if !ok {
// 		nwdafSelf.UEGroupCollection.Store(ueGroupId, new(udr_context.UEGroupSubsData))
...
// 		nwdafSelf.GetIPv4GroupUri(udr_context.NUDR_DR), ueGroupId, newSubscriptionID)
...
// 	value, ok := nwdafSelf.UESubsCollection.Load(ueId)
// 	if !ok {
// 		nwdafSelf.UESubsCollection.Store(ueId, new(udr_context.UESubsData))
...
// 		nwdafSelf.GetIPv4GroupUri(udr_context.NUDR_DR), ueId, newSubscriptionID)
...
// 		nwdafSelf.GetIPv4GroupUri(udr_context.NUDR_DR), newSubscriptionID)
